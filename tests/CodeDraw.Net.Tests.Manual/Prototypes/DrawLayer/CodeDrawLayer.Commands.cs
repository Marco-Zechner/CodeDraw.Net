...
public sealed unsafe partial class CodeDrawLayer
{
    ...
    private sealed class CmdSetBlitShader : ICmd
    {
        ...
        {
            self._customBlitShader = Shader;

            // invalidate fixed cache
            self._customFixedKey = null;

            // invalidate auto cache
            self._customAutoProgram = null;
            self._customAuto_uTex = null;
            self._customAutoStore = null;
        }
    }
